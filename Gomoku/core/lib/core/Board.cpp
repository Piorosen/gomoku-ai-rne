...
int Board::GetKey(int x, int y, int i)
{
	...
	int key = (cell[x - stepX * 4][y - stepY * 4].piece) ^ (cell[x - stepX * 3][y - stepY * 3].piece << 2) ^ (cell[x - stepX * 2][y - stepY * 2].piece << 4) ^ (cell[x - stepX * 1][y - stepY * 1].piece << 6) ^ (cell[x + stepX * 1][y + stepY * 1].piece << 8) ^ (cell[x + stepX * 2][y + stepY * 2].piece << 10) ^ (cell[x + stepX * 3][y + stepY * 3].piece << 12) ^ (cell[x + stepX * 4][y + stepY * 4].piece << 14);
	return key;
}
